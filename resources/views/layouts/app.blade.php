...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body>
        <div id="app">
            <nav class="navbar navbar-expand-md navbar-light bg-primary shadow-sm barra sticky-top">
                <div class="container">
                    ...
                    >
                        ...
                        <ul class="navbar-nav ml-auto">
                            ...
                            <li class="nav-item dropdown">
                                ...
                                >
                                    <a href="{{ route('perfiles.show', ['perfil' => auth()->user()->id]) }}" class="dropdown-item">Perfil</a>
                                    <a href="{{ route('recetas.index') }}" class="dropdown-item">Ver Recetas</a>
